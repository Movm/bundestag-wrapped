/**
 * Native Slide Components
 *
 * React Native implementations of the Bundestag Wrapped slides.
 * Uses shared content from @/shared/ and native animations from Reanimated.
 */
